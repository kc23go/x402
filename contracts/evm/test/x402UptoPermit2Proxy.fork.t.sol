...
/// @title X402UptoPermit2ProxyForkTest
/// @notice Fork tests against real Permit2 deployment for flexible amount transfers
/// @dev Run with: forge test --match-contract X402UptoPermit2ProxyForkTest --fork-url $RPC_URL
contract X402UptoPermit2ProxyForkTest is Test {
